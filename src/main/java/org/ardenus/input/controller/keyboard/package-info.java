 ...
 */
/**
 * Components implementing keyboard and mouse input support for the input
 * system.
 * <p>
 * These components do not only implement support for base keyboard and mouse
 * support. They also add support for things like Logitech's LogiLED system and
 * Razer LED technology for keyboards and mouses.
 * 
